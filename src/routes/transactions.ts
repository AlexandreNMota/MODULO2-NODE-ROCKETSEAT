...
// No contexto do front é um usuário
// No contexto do backend o user é o frontend

// Piramide de testes: E2E (Não dependem de nenhuma trcnologia, não dependem de arquitetura)
